      ...
      hallucinations: [
        {
          action: {
            ...
            hallucinated: true,
            flavor:
              'AI: "Gerak? Oke, aku gerakkan ke... mana ya? Biar random aja."',
          },
          weight: 3,
        },
        {
      ...
      hallucinations: [
        {
          action: {
            ...
            hallucinated: true,
            flavor:
              'AI: "Kanan? Hmm, kanan dari sudut pandang siapa? Aku pilih kiri."',
          },
          weight: 3,
        },
        {
      ...
      hallucinations: [
        {
          action: {
            ...
            hallucinated: true,
            flavor:
              'AI: "Cepat? Oke, cepat versi siput. Teknisnya tetap bergerak."',
          },
          weight: 3,
        },
        {
      ...
      hallucinations: [
        ...
        },
        {
          action: {
            ...
            hallucinated: true,
            flavor:
              'AI: "Bendera? Oke aku pindahkan benderanya. *bendera kabur*"',
